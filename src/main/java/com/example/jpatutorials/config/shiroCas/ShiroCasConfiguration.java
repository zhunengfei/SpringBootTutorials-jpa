package com.example.jpatutorials.config.shiroCas;
...
public class ShiroCasConfiguration {
  ...
  public static final String loginUrl =
      casLoginUrl + "?service=" + shiroServerUrlPrefix + casFilterUrlPattern;
  // 登出地址
...
//      <!-- 用户授权/认证信息Cache, 采用EhCache 缓存 -->
  ...
  /**
   * ShiroFilter<br/> 注意这里参数中的 StudentService 和 IScoreDao 只是一个例子，因为我们在这里可以用这样的方式获取到相关访问数据库的对象，
  ...
  public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultWebSecurityManager securityManager,
      CasFilter casFilter, UserDao userDao) {
  ...
  private void loadShiroFilterChain(ShiroFilterFactoryBean shiroFilterFactoryBean,
    ...
    filterChainDefinitionMap
        .put("/user/delete/**", "authc,perms[\"user:delete\"]"); //需要登录，且用户有权限为user:delete

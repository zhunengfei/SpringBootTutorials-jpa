package com.example.jpatutorials.controller.datajpa;
...
public class UserController {
  ...
  @ResponseBody
  public List<User> getAllUserByPage(@PathVariable("page") int page,
  ...
  @ResponseBody
  public User updateUser(@PathVariable("id") int id, @PathVariable("number") String number,
      @PathVariable("name") String name, boolean throwEx) {
    User user = new User();
    user.setId(id);
